...
from backend.utils import cert_hash, check_signature_belongs_to_certificate_valid, create_table, add_user_certificate, get_certificate_by_user
...
def test_db_execution_flow():
    ...
    with open("tests/signed_cert1.pem", "rb") as valid_cert_file:
        valid_cert_data = valid_cert_file.read()
    add_user_certificate("iago123", valid_cert_data)
